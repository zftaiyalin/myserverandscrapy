...
from myscrapy_project.utils.common import extract_num,get_md5
from myscrapy_project.settings import SQL_DATETIME_FORMAT
from w3lib.html import remove_tags
from scrapy_djangoitem import DjangoItem
from apps.Tutorials.models import TutorialsVedio
...
class TutorialsVedioItem(DjangoItem):
    django_model = TutorialsVedio
